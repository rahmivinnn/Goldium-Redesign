...
// GOLD token mint address (example)
const GOLD_TOKEN_MINT = 'GOLDxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx';

export function IntegratedWalletSelector() {
